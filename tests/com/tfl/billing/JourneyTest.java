...
public class JourneyTest {
    ...
    public void setUp() throws InterruptedException {
        ...
        long startDate = 0;
        startEvent = new JourneyStart(UUID.fromString("10000000-0000-0000-0000-00000000000"), UUID.fromString("20000000-0000-0000-0000-000000000000"), startDate);
        dateStart = new Date(0);
        dateEnd = new Date();
        dateEnd.setTime(1000 * 60 * 5);
        endEvent = new JourneyEnd(UUID.fromString("30000000-0000-0000-0000-000000000000"), UUID.fromString("40000000-0000-0000-0000-000000000000"), 1000 * 60 * 5);
    ...
    public void returnsCorrectOriginID() {
        assertTrue(journey.originId().equals(UUID.fromString("20000000-0000-0000-0000-000000000000")));
    }

    @Test
    public void returnsDestinationID() {
        assertTrue(journey.destinationId().equals(UUID.fromString("40000000-0000-0000-0000-000000000000")));
    }
    ...
    public void longJourneyIsIdentified() {
        ...
        JourneyEvent startEvent = new JourneyStart(UUID.fromString("10000000-0000-0000-0000-00000000000"), UUID.fromString("20000000-0000-0000-0000-000000000000"));
        long time = System.currentTimeMillis() + 26 * 60 * 1000;
        JourneyEvent longEndEvent = new JourneyEnd(UUID.fromString("30000000-0000-0000-0000-000000000000"), UUID.fromString("40000000-0000-0000-0000-000000000000"), time);
